...
*This plugin has been adopted by PluginChief under the Plugin Recycle program for more information go to pluginchief.com all of your favorite plugins will be kept up to date on the wordpress repository.
...
* Added if(!class_exists('PLUGINCHIEF_Widget_Base') check to the widget base class PLUGINCHIEF_Widget_Base
